const selectedMarker = (state = {id: null, lat: null, lng: null, createdById: null, avgRating: null, userRating: null}, action) => {
	switch (action.type) {
		...
		case 'CLEAR_SELECTED_MARKER':
			return {id: null, lat: null, lng: null, createdById: null, avgRating: null, userRating: null}
		default:
			return state;
	}
}
